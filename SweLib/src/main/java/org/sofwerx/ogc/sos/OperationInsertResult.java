...
public class OperationInsertResult extends AbstractSosOperation {
    ...
    /**
     * Gets the assigned template. This is slightly redundant (i.e. it should be in the
     * SosSensor as well, but exists for times when an InsertResult is received without
     * a previous InsertSensor/Insert/Template and the parser has to try to reconstruct
     * the sensor
     * @return
     */
    public String getAssignedTemplate() {
     ...
     */
    public void setAssignedTemplate(String assignedTemplate) {
